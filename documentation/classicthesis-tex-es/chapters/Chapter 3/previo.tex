...
\begin{table}[H]
\centering
\caption{Clasificación de los trabajos realizados en el campo de la Minería de Procesos.}
\label{tab:classification}
\begin{tabular}{|>{\centering\arraybackslash}m{2cm}|>{\centering\arraybackslash}m{5cm}|>{\centering\arraybackslash}m{5cm}|>{\centering\arraybackslash}m{5cm}|}
\hline
\rowcolor{orange!20}
\backslashbox{\scriptsize{\textbf{Nodos}}}{\scriptsize{\textbf{Aristas}}} & \small{\textbf{Energía} (Conteo)} & \small{\textbf{Cercanía} (Clustering)} & \small{\textbf{Orden} (Precedencia)} \\ 
\hline 
...
\begin{tabular}[t]{
  ...
  \hline
  \rowcolor{gray!20}
  \cellcolor{cyan!25}\textbf{Pasado} & \cellcolor{lime!25}\textbf{Presente} & \cellcolor{pink!50}\textbf{Futuro} \\
  \hline
  \rowcolor{white}
  Coursera. Validación del curso. Uso de recursos. & Patrones de uso. Seguimiento. & Cuellos de botella. Posibles problemas. Recomendaciones. \\
  \hline
  \end{tabular}
...
\begin{tabular}[t]{
  ...
  \hline
  \rowcolor{white}
  Trabajo en grupo bien estructurado. & Medidas intragrupos e intergrupos. Redes sociales. & Liderazgo. Dominancia. Personas influyentes. \\
  \hline
  \end{tabular}
...
\begin{tabular}[t]{
  ...
  \hline
  \rowcolor{white}
  Validación del curso. Concienciación del profesorado. & Relaciones intergrupos. Redes sociales. &  \\
  \hline
  \end{tabular} 
