...
\begin{figure}[H]
\centering
\subfloat[Grafo acíclico dirigido que captura el comportamiento de un grupo con $372$ sesiones de trabajo.]{\label{fig:bad}\includegraphics[width=0.47\textwidth]{estado/DBA_1617_P2_GJ_9.png}}\qquad
\subfloat[Grafo acíclico dirigido que captura el comportamiento de un grupo con $297$ sesiones de trabajo.]{\label{fig:good}\includegraphics[width=0.47\textwidth]{estado/DBA_1516_P2_GC_9.png}}
