...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.70\textwidth]{densityallsessions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.60\textwidth]{boxplotallsessions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{confidenceallsessions.png}
