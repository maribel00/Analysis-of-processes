...
Nótese que como hemos una obtenido una precisión del $0.9802671\% > 95\%$, no eliminaremos más outliers.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.60\textwidth]{análisis/boxplots.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{análisis/confidenceallsessions.png}
