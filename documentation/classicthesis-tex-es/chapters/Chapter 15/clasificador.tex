...
\begin{figure}[H]
\centering
\subfloat[Regla 1 de entre las generadas por C5.0 (Cuadro \ref{rulesend1}).]{\label{fig:rule1}\includegraphics[width=0.30\textwidth]{clasificación/regla1.png}}\qquad
\subfloat[Función de densidad de probabilidad del número de sesiones normalizado.]{\label{fig:densityns2}\includegraphics[width=0.46\textwidth]{clasificación/densityns.png}}\qquad
\subfloat[Función de densidad de probabilidad del tiempo de reacción normalizado.]{\label{fig:densityrt2}
\includegraphics[width=0.46\textwidth]{clasificación/densityrt.png}}\qquad
\subfloat[Función de densidad de probabilidad de la medida de similaridad del coseno.]{\label{fig:densitysq2}
\includegraphics[width=0.46\textwidth]{clasificación/densitysq.png}}\qquad
...
\begin{figure}[H]
\centering
\subfloat[Regla 4 de entre las generadas por C5.0 (Cuadro \ref{rulesend1}).]{\label{fig:rule4}\includegraphics[width=0.30\textwidth]{clasificación/regla4.png}}\qquad
\subfloat[Función de densidad de probabilidad del número de problemas resueltos normalizado.]{\label{fig:densitynp3}
\includegraphics[width=0.46\textwidth]{clasificación/densitynp.png}}\qquad
\subfloat[Función de densidad de probabilidad del tiempo de reacción normalizado.]{\label{fig:densityrt3}
\includegraphics[width=0.46\textwidth]{clasificación/densityrt.png}}\qquad
\caption{La regla $4$ nos indica que un grupo está en riesgo si no ha resuelto todos los problemas (\texttt{np <= 0.8888889}) y tarda mucho en resolverlos una vez abiertos por primera vez (\texttt{rt > 0.3676471}). Las Figuras \ref{fig:densitynp3} y \ref{fig:densityrt3} muestran las funciones de densidad de probabilidad de las variables involucradas en la regla que se muestra en la Figura \ref{fig:rule4}.}
\label{fig:regla4}
\end{figure}
...
\phantomsection \label{rulesend1}  
...
\phantomsection \label{rulesbegin1}  
...
\phantomsection \label{rulesend2}  
...
\phantomsection \label{rulesbegin2}  
