...
\item \hyperref[sec:diferencias]{Capítulo 13}: Capacidad de las métricas. Estudio de las diferentes métricas en torno a su capacidad de separación entre alumnos en riesgo de obtener peores resultados y los que no presentarán dificultades para superar los problemas propuestos.
