...
write.csv(data_filtered, "datasetS.csv", row.names = FALSE)
...
# Write the cleaned dataset into a .csv file
write.csv(data_filtered, "datasetA.csv", row.names = FALSE)
...
# Write the cleaned dataset into a .csv file
write.csv(data_filtered, "datasetN.csv", row.names = FALSE)
...
# Write the cleaned dataset into a .csv file
write.csv(data_filtered, "datasetSOB.csv", row.names = FALSE)
...
# Write the cleaned dataset into a .csv file
write.csv(data_filtered, "datasetMH.csv", row.names = FALSE)