...
allmetrics=c("NDAG", allmetricsF()) #c("ns","nt","np","ot","st","rt","ft","ps","fr","sq")
...
# Exactly the number of metrics to combine
minmetrics=4
if (file.exists(paste(pwd,"dsbase.RDS",sep=""))) {
  SIIE23doInitDatasets()
  dsbase=readRDS(paste(pwd,"dsbase.RDS",sep=""))
