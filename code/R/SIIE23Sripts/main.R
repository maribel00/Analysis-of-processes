setwd('./Escritorio/5º DGIIM/TFG/Analysis-of-processes/code/R/SIIE23Sripts/')
...
graphoptions4 <- graphoptions('SIIE2023_4',fieldactivity='State',minproblems=1)
...
data_agg <- SIIE23doGenerateDatasets(downto=1)
