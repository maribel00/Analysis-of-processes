...
allmetricsF<-function() {
  ...
  #          #"graph_NProblemsSolved",
  #          "graph_Betweenness", "graph_meanEnergy", "graph_maxEnergy",
  #        "graph_AvrgDeg", "graph_Density", "graph_Connectedness"))
  # return (c("ns","np","ot","st","rt","ft","ps","fr","sq","nt", "cx"))
}
