...
graphoptions2 <- graphoptions('SIIE2023_2', fieldactivity='Problem', minproblems = 1, maxproblems = 10)
graphoptions3 <- graphoptions('SIEE2023_3', minproblems = 1, maxproblems = 10) 
...
graph2 <- GraphMinerProblems(SIIE23RAW, graphoptions2, graphpwd2, "None")
graphpwd3 <- "./GraphsStates"
graph3 <- GraphMinerProblems(SIIE23RAW, graphoptions3, graphpwd3, "circo")
graphpwd4 <- "./GraphsStates_wc"
graph4 <- GraphMinerStates(SIIE23RAW, graphoptions4, graphpwd4, "circo")
